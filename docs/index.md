...
??? quote "Python Engineer | US Startup"
    - Developed MVP project’s backend from scratch using python, flask, celery, redis, docker, mongodb for a client in a team. 
...
???+ note "Django ile Deployment Odaklı Geliştirme | Udemy"
